...
#' @field par_method Character. If `parallel=TRUE` choose the method to go parallel: `multisession` (default) works in Windows and in Linux.
#'                   `multicore` works in Linux.
#'
